...
class ProfileConfig(TypedDict, total=False):
    ...
    editable_fields: List[str]  # ['full_name', 'email', 'phone', 'city', 'bio']
...
class AuthComponents:
    ...
    @staticmethod
    def social_login_buttons(providers: List[str] = None) -> str: # type: ignore
    ...
    def auth_header(title: str, subtitle: Optional[str] = None, logo: Optional[str] = None) -> str:
        ...
        subtitle_html = f'<p class="text-sm text-base-content/70 mt-2">{subtitle}</p>' if subtitle else ""

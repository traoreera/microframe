"""
Voici une version propre, concise et pro.

---

# **AuthX — JWT Authentication for Starlette**

AuthX is a modular JWT authentication system tailored for Starlette and compatible with any ASGI framework. It brings a clean and extensible architecture to secure APIs with strong authentication practices.

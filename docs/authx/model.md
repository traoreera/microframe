...
| ---------- | ---------- | ------------------------------- | ---------------------------------------------- |
| `email`    | `EmailStr` | `8-50 chars`, alias: `username` | Must be a valid email                          |
| `password` | `str`      | `8-50 chars`, alias: `passwrd`  | Plain text input, handled securely server-side |
